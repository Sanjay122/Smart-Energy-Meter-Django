    ...
    while date_pointer < today:
        ...
        while hour < 24:
            for i in range(range_count):
                ...
                power_consumed += average_voltage * average_current * average_power_factor / 360
        ...
        if previous_pointer is None:
            ...
            if date_pointer.month != previous_pointer.month:
                ...
                bill = models.Bill(consumer_id=1,
                                   year=previous_pointer.year,
                                   month=previous_pointer.month,
                ...
                try:
                    models.WithinADayData.objects.get(consumer_id=1, year=previous_2_month_date.year,
                                                      month=previous_2_month_date.month).delete()
                    models.DayWiseData.objects.get(consumer_id=1, year=previous_2_month_date.year,
                                                   month=previous_2_month_date.month).delete()
                    models.WeekWiseData.objects.get(consumer_id=1, year=previous_2_month_date.year,
                                                    month=previous_2_month_date.month).delete()
                except:
